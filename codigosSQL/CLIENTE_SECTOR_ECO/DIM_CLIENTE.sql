...
COMMENT ON COLUMN DIM_CLIENTE.DT_FECHA_INICIO IS 'FECHA DE INSERCION DE LOS REGISTROS';
...
CREATE TABLE DIM_CLIENTE (
    SK_NUM_DIM_CLIENTE NUMBER(7), secuencia
    STR_NIT NUMBER(15) NOT NULL,    t200
    STR_RAZON_SOCIAL VARCHAR2(100), t200
